...
using DisableFleaMarket.Patches;

namespace DisableFleaMarket
{
    // first string below is your plugin's GUID, it MUST be unique to any other mod.
    // Read more about it in BepInEx docs. Be sure to update it if you copy this project.
